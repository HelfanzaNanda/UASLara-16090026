    ...
    <section class="section-margin">
        <div class="container">
            ...
            <div class="d-lg-flex justify-content-between">
                <div class="card-feature mb-6 mb-lg-0">
                    <h3>Visi</h3>
                    <p>Menjadikan HIMAPRODI TI yang profesional dan berkualitas, demi terwujudnya visi misi Prodi Teknik Informatika. Dengan semangat yang HIMAPRODI TI yang responsif, agresif, dan Inovatif</p>
                </div>

                <div class="card-feature mb-6 mb-lg-0">
                    <h3>Misi</h3>
                    <p>Mewujudkan aktivitas yang agamis</p>
                    <p>Meningkatkan Kualitas Prodi TI di bidang akademik dan Non-Akademik</p>
                </div>
